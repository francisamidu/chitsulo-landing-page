    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-0">
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="bg-slate-900 text-white p-12 lg:p-16 flex flex-col justify-end">
            {/* Quote Icon */}
            <div>
              <div className="mb-1">
                <div className="text-6xl text-white/20 italic">"</div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between">
              ...
              {/* Navigation Chevrons */}
              <div className="flex gap-3 order-1 sm:order-2 mb-4 md:mb-0">
                <button
                  onClick={handlePrev}
